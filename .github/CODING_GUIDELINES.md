...
This document outlines the coding standards and best practices for the FFS (Friendly File Server)
project. All contributors, including AI coding agents, should follow these guidelines to maintain
...
**The codebase follows a philosophy of minimal commenting.** Code should be self-documenting
through:
...
**Statistics:** The codebase maintains approximately 0.5% comment-to-code ratio (18 comments in
~3,249 lines of code).
...
- Functions should be named as actions (verbs): `registerRoutes`, `validateUser`,
  `generateThumbnail`
